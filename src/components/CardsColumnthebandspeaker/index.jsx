...
const CardsColumnthebandspeaker = (props) => {
  return (
    <>
      <div className={props.className}>
        <div className="bg-bluegray_50 flex h-[224px] md:h-[auto] items-center justify-center p-[16px] w-[100%]">
          <Img
        ...
        <div className="flex flex-col gap-[16px] items-start justify-start p-[16px] w-[100%]">
          <div className="flex flex-col gap-[8px] items-start justify-start w-[100%]">
            ...
            <Text
              className="font-poppins leading-[128.00%] md:max-w-[100%] max-w-[288px] text-black_900 text-left tracking-[-0.50px]"
              as="h6"
              variant="h6"
            >
              {props?.language}
            ...
            <Text
              className="font-normal font-poppins leading-[150.00%] md:max-w-[100%] max-w-[288px] not-italic text-black_900 text-left"
              variant="body6"
            >
              {props?.timeZone}
            </Text>
...
CardsColumnthebandspeaker.defaultProps = {
...
export default CardsColumnthebandspeaker;
