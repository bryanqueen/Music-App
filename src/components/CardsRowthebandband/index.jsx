...
const CardsRowthebandband = (props) => {
  return (
    <>
      <div className={props.className}>
        <div className="bg-gray_800 flex h-[256px] md:h-[auto] items-center justify-center p-[16px] w-[264px]">
          <Img
            src="images/img_thebandband_224x232.png"
        ...
        <div className="flex flex-col gap-[16px] h-[256px] md:h-[auto] items-start justify-start p-[16px] sm:w-[100%] w-[407px]">
          <div className="flex flex-col gap-[8px] h-[100%] items-start justify-start w-[100%]">
            ...
            <Text
              className="font-poppins leading-[128.00%] md:max-w-[100%] max-w-[375px] text-left text-white_A700 tracking-[-0.50px]"
              as="h6"
              variant="h6"
            >
              {props?.language}
            ...
            <Text
              className="font-normal font-poppins leading-[150.00%] md:max-w-[100%] max-w-[375px] not-italic text-left text-white_A700"
              variant="body6"
            >
              {props?.description}
            </Text>
...
CardsRowthebandband.defaultProps = {
...
export default CardsRowthebandband;
